# Specialized verification and live boundaries

On-demand reference for `docs/agent/verification.md`: read only the section for your change. Moved verbatim from `docs/agent/verification.md` on 2026-09-26 (NOW-OPT-AGENT-DOCS-SLIM-001). The executed Phase 1 Projects acceptance record and the executed Stone adoption-plan command were retired to `docs/archive/2026-09-26/docs__agent__verification.md`, which keeps the complete previous text.
