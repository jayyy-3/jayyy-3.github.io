...
- `/admin/settings` also includes a non-destructive admin team manager for existing login accounts, with owner/admin profile create/update controls, owner-role guardrails, self-lockout prevention, role explanations, and no delete controls.
