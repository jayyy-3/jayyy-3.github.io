...
- Recent homepage partner-banner copy polish on 2026-05-26: the banner now uses `Design-led stone solutions for streetscapes & civil landscapes.` and renders from `src/data/homepage.ts` instead of hardcoded JSX copy.
