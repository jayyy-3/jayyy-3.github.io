...
- Public Stone Library origin is an internal-only sourcing field: public cards, detail specs, search matching, and route metadata omit it without deleting the source/Supabase/Admin value.
