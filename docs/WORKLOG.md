...
- Production is unchanged. No Supabase row, Storage object, CMS content, Auth user, migration, email, custom domain, or production deployment was written. Preview and Jay's visual acceptance remain the release boundary.
