...
| ID | 状态 / 阶段 | 内容 | 阻塞 |
|---|---|---|---|
| NOW-STONE-PROJECT-REFS-001 | now / awaiting_external | Link Stone Library and Projects both ways: quiet public material-point cards with deep links, Stone "Used in projects", and material points on any Project media image in a reshaped admin editor. | Stacked PRs #50 (phase 1), #51 (phase 2) and #52 (phase 3) are not merged; merge in order after acceptance. |
