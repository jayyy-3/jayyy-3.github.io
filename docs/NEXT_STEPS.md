...
| ID | 状态 / 阶段 | 内容 | 阻塞 |
|---|---|---|---|
| NOW-ADMIN-STONE-WORKSPACE-001 | blocked / awaiting_external | Deliver the page-shaped Stone Library workspace and approved current-public-baseline adoption. | PR #47 source and immutable Preview checks passed. Production migrations, 12-stone/55-photo adoption and tagged workflows require approval of docs/STONE_LIBRARY_WORKSPACE_RELEASE.md. |
