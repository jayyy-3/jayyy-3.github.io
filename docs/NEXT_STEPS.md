...
- Deploy the Image QR branch Preview and run no-write smoke. Before any tagged Image QR upload/replace/Hide/Restore proof, obtain a separate write approval; source and migration checks do not substitute for Jay's final usability test.
