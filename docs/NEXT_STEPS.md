...
- Asset migration stopgap: launch-critical logo, homepage poster/video, route banners, contact imagery, homepage section imagery, partner logos, and Our Story imagery now have controlled local assets under `public/media/launch`; `NOW-ASSET-MIGRATION-001` remains active for legacy project media, Stone Library fallback media, article media, and CMS media migration.
