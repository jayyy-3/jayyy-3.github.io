...
| ID | 状态 / 阶段 | 内容 | 阻塞 |
|---|---|---|---|
| NOW-COMPANY-ADDRESS-001 | now / implementation | Publish the approved Office/Warehouse addresses with shared Settings management. | — |
| NOW-STONE-PROJECT-REFS-001 | now / awaiting_external | Link Stone Library and Projects both ways: quiet public material-point cards with deep links, Stone "Used in projects", and material points on any Project media image in a reshaped admin editor. | Jay usability acceptance of the Projects points editor in production. |
