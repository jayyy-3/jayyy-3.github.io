...
| Projects | Edit case studies, facts, materials, images, maps, and hotspots. | One page-shaped draft with Overview/Facts/Materials/Media/Maps, one Save action, shared preview, inline media, visual hotspots, Publish, and Hide. Inline uploads retain the full-quality original; the public website prepares high-quality card, detail, hero, and map versions automatically. There is no separate proof-review approval step. Jay's fool test remains the acceptance gate. |
