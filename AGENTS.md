...
18. Production Media role migration `20260714050750_media_public_bucket_role_hardening.sql` is applied and read back. Before the final CMS handoff audit, and only after Jay separately approves tagged Storage writes, run:
