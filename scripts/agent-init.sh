...
echo "3. docs/agent/status.json"
echo "4. docs/agent/tasks.json"
echo "5. docs/agent/verification.md"
echo "6. docs/brand-baseline.md"
echo "7. docs/DESIGN.md"
echo "8. docs/ARCHITECTURE.md"
echo "9. docs/SUPABASE_SCHEMA.md when working on Supabase/admin"
echo "10. docs/ADMIN_IA_ACCESS.md when working on /admin"
echo "11. docs/NEXT_STEPS.md"
echo "12. docs/WORKLOG.md when historical evidence is needed"
echo
...
echo "- npm run agent:admin-media-role-boundary-live"
...
echo "- npm run agent:public-content-overlay"
