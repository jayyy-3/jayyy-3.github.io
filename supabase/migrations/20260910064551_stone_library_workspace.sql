...
create or replace function private.stone_qr_default(p_name text)
returns jsonb language sql immutable set search_path='' as $$
with raw as (select regexp_split_to_array(coalesce(p_name,''),'\s*[·_]\s*') parts),
 names as (select regexp_replace(lower(parts[1]),'[^a-z0-9]','','g') stone,regexp_replace(lower(parts[2]),'[^a-z0-9]','','g') finish from raw),
 matches as (select o from jsonb_array_elements('[{"stoneGroupId":"alpine-white","stoneVariantId":"alpine-white","finishKey":"flamed","stoneName":"Alpine White","variantName":"Standard","finishName":"Flamed"},{"stoneGroupId":"alpine-white","stoneVariantId":"alpine-white","finishKey":"sawn","stoneName":"Alpine White","variantName":"Standard","finishName":"Sawn"},{"stoneGroupId":"alpine-white","stoneVariantId":"alpine-white","finishKey":"honed","stoneName":"Alpine White","variantName":"Standard","finishName":"Honed"},{"stoneGroupId":"alpine-white","stoneVariantId":"alpine-white","finishKey":"polished","stoneName":"Alpine White","variantName":"Standard","finishName":"Polished"},{"stoneGroupId":"angola-black","stoneVariantId":"angola-black","finishKey":"flamed","stoneName":"Angola Black","variantName":"Standard","finishName":"Flamed"},{"stoneGroupId":"angola-black","stoneVariantId":"angola-black","finishKey":"sawn","stoneName":"Angola Black","variantName":"Standard","finishName":"Sawn"},{"stoneGroupId":"angola-black","stoneVariantId":"angola-black","finishKey":"honed","stoneName":"Angola Black","variantName":"Standard","finishName":"Honed"},{"stoneGroupId":"angola-black","stoneVariantId":"angola-black","finishKey":"polished","stoneName":"Angola Black","variantName":"Standard","finishName":"Polished"},{"stoneGroupId":"angola-black","stoneVariantId":"angola-black","finishKey":"bush_hammered","stoneName":"Angola Black","variantName":"Standard","finishName":"Bush Hammered"},{"stoneGroupId":"blueocean","stoneVariantId":"blueocean","finishKey":"sawn","stoneName":"BlueOcean","variantName":"Standard","finishName":"Sawn"},{"stoneGroupId":"blueocean","stoneVariantId":"blueocean","finishKey":"honed","stoneName":"BlueOcean","variantName":"Standard","finishName":"Honed"},{"stoneGroupId":"blueocean","stoneVariantId":"blueocean","finishKey":"bush_hammered","stoneName":"BlueOcean","variantName":"Standard","finishName":"Bush Hammered"},{"stoneGroupId":"blueocean","stoneVariantId":"blueocean","finishKey":"combed","stoneName":"BlueOcean","variantName":"Standard","finishName":"Combed"},{"stoneGroupId":"blueocean","stoneVariantId":"blueocean","finishKey":"rock_face","stoneName":"BlueOcean","variantName":"Standard","finishName":"Rock Face"},{"stoneGroupId":"blueocean","stoneVariantId":"blueocean","finishKey":"rippling__fine","stoneName":"BlueOcean","variantName":"Standard","finishName":"Rippling (Fine)"},{"stoneGroupId":"blueocean","stoneVariantId":"blueocean","finishKey":"rippling__rough","stoneName":"BlueOcean","variantName":"Standard","finishName":"Rippling (Rough)"},{"stoneGroupId":"golden-crust","stoneVariantId":"golden-crust--light","finishKey":"flamed","stoneName":"Golden Crust","variantName":"Light","finishName":"Flamed"},{"stoneGroupId":"golden-crust","stoneVariantId":"golden-crust--light","finishKey":"sawn","stoneName":"Golden Crust","variantName":"Light","finishName":"Sawn"},{"stoneGroupId":"golden-crust","stoneVariantId":"golden-crust--light","finishKey":"honed","stoneName":"Golden Crust","variantName":"Light","finishName":"Honed"},{"stoneGroupId":"golden-crust","stoneVariantId":"golden-crust--light","finishKey":"polished","stoneName":"Golden Crust","variantName":"Light","finishName":"Polished"},{"stoneGroupId":"golden-crust","stoneVariantId":"golden-crust--dark","finishKey":"flamed","stoneName":"Golden Crust","variantName":"Dark","finishName":"Flamed"},{"stoneGroupId":"golden-crust","stoneVariantId":"golden-crust--dark","finishKey":"sawn","stoneName":"Golden Crust","variantName":"Dark","finishName":"Sawn"},{"stoneGroupId":"golden-crust","stoneVariantId":"golden-crust--dark","finishKey":"honed","stoneName":"Golden Crust","variantName":"Dark","finishName":"Honed"},{"stoneGroupId":"golden-crust","stoneVariantId":"golden-crust--dark","finishKey":"polished","stoneName":"Golden Crust","variantName":"Dark","finishName":"Polished"},{"stoneGroupId":"honey-comb","stoneVariantId":"honey-comb","finishKey":"sawn","stoneName":"Honey Comb","variantName":"Standard","finishName":"Sawn"},{"stoneGroupId":"honey-comb","stoneVariantId":"honey-comb","finishKey":"honed","stoneName":"Honey Comb","variantName":"Standard","finishName":"Honed"},{"stoneGroupId":"ivory-sand","stoneVariantId":"ivory-sand","finishKey":"honed","stoneName":"Ivory Sand","variantName":"Standard","finishName":"Honed"},{"stoneGroupId":"ivory-sand","stoneVariantId":"ivory-sand","finishKey":"bush_hammered","stoneName":"Ivory Sand","variantName":"Standard","finishName":"Bush Hammered"},{"stoneGroupId":"ivory-sand","stoneVariantId":"ivory-sand","finishKey":"sparrow_peck","stoneName":"Ivory Sand","variantName":"Standard","finishName":"Sparrow Peck"},{"stoneGroupId":"juparana","stoneVariantId":"juparana","finishKey":"flamed","stoneName":"Juparana","variantName":"Standard","finishName":"Flamed"},{"stoneGroupId":"juparana","stoneVariantId":"juparana","finishKey":"sawn","stoneName":"Juparana","variantName":"Standard","finishName":"Sawn"},{"stoneGroupId":"juparana","stoneVariantId":"juparana","finishKey":"honed","stoneName":"Juparana","variantName":"Standard","finishName":"Honed"},{"stoneGroupId":"juparana","stoneVariantId":"juparana","finishKey":"polished","stoneName":"Juparana","variantName":"Standard","finishName":"Polished"},{"stoneGroupId":"new-grey","stoneVariantId":"new-grey","finishKey":"flamed","stoneName":"New Grey","variantName":"Standard","finishName":"Flamed"},{"stoneGroupId":"new-grey","stoneVariantId":"new-grey","finishKey":"sawn","stoneName":"New Grey","variantName":"Standard","finishName":"Sawn"},{"stoneGroupId":"new-grey","stoneVariantId":"new-grey","finishKey":"honed","stoneName":"New Grey","variantName":"Standard","finishName":"Honed"},{"stoneGroupId":"new-grey","stoneVariantId":"new-grey","finishKey":"polished","stoneName":"New Grey","variantName":"Standard","finishName":"Polished"},{"stoneGroupId":"tan-brown","stoneVariantId":"tan-brown","finishKey":"flamed","stoneName":"Tan Brown","variantName":"Standard","finishName":"Flamed"},{"stoneGroupId":"tan-brown","stoneVariantId":"tan-brown","finishKey":"sawn","stoneName":"Tan Brown","variantName":"Standard","finishName":"Sawn"},{"stoneGroupId":"tan-brown","stoneVariantId":"tan-brown","finishKey":"honed","stoneName":"Tan Brown","variantName":"Standard","finishName":"Honed"},{"stoneGroupId":"tan-brown","stoneVariantId":"tan-brown","finishKey":"polished","stoneName":"Tan Brown","variantName":"Standard","finishName":"Polished"},{"stoneGroupId":"tuscany","stoneVariantId":"tuscany--vein-cut","finishKey":"honed","stoneName":"Tuscany","variantName":"Vein Cut","finishName":"Honed"},{"stoneGroupId":"tuscany","stoneVariantId":"tuscany--cross-cut","finishKey":"honed","stoneName":"Tuscany","variantName":"Cross Cut","finishName":"Honed"},{"stoneGroupId":"zen-grey","stoneVariantId":"zen-grey","finishKey":"flamed","stoneName":"Zen Grey","variantName":"Standard","finishName":"Flamed"},{"stoneGroupId":"zen-grey","stoneVariantId":"zen-grey","finishKey":"sawn","stoneName":"Zen Grey","variantName":"Standard","finishName":"Sawn"},{"stoneGroupId":"zen-grey","stoneVariantId":"zen-grey","finishKey":"honed","stoneName":"Zen Grey","variantName":"Standard","finishName":"Honed"},{"stoneGroupId":"zen-grey","stoneVariantId":"zen-grey","finishKey":"polished","stoneName":"Zen Grey","variantName":"Standard","finishName":"Polished"}]'::jsonb) o,names n
 where regexp_replace(lower(o->>'stoneName'),'[^a-z0-9]','','g')=case n.stone when 'steelblue' then 'blueocean' when 'toscany' then 'tuscany' when 'glodencrust' then 'goldencrust' else n.stone end
 and (regexp_replace(lower(o->>'finishName'),'[^a-z0-9]','','g')=n.finish or (o->>'stoneGroupId'='tuscany' and regexp_replace(lower(o->>'variantName'),'[^a-z0-9]','','g')=n.finish and o->>'finishKey'='honed')))
select case when count(*)=1 then jsonb_build_object('stoneGroupId',min(o->>'stoneGroupId'),'stoneVariantId',min(o->>'stoneVariantId'),'finishKey',min(o->>'finishKey'))
 else '{"stoneGroupId":"zen-grey","stoneVariantId":"zen-grey","finishKey":"honed"}'::jsonb end from matches;
$$;
revoke all on function private.stone_qr_default(text) from public,anon,authenticated;
...
select coalesce(jsonb_agg(r order by r->>'module',r->>'name'),'[]'::jsonb) from (
 ...
 union all
 select jsonb_build_object('module','image-qr','id',q.id,'name',q.name,'path','/admin/image-qr',
 'live',q.status='active','variantId',coalesce((select v.id from public.stone_variants v where v.stone_group_id=p_id and v.variant_key=sel.value->>'stoneVariantId' limit 1),-1),
 'finishId',coalesce((select f.id from public.finish_definitions f where f.finish_key=sel.value->>'finishKey'),-1),'source',case when q.status='active' then 'content' else 'history' end)
 from public.image_qr_resources q cross join lateral (select coalesce(q.material_selection,private.stone_qr_default(q.name)) value) sel
 where sel.value->>'stoneGroupId'=(select stone_group_key from public.stone_groups where id=p_id)
 union all
