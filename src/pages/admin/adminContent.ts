...
export const adminModules: AdminModuleDefinition[] = [
    ...
    },
    {
        ...
        label: 'Articles',
        path: '/admin/articles',
        summary: 'Article details, cover media, search previews, and structured story blocks.',
        handoffLabel: 'Structured story content',
        group: 'content',
        Icon: BookOpenText,
    },
    {
